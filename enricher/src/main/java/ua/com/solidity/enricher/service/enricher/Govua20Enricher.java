...
public class Govua20Enricher implements Enricher {
    private static final String SOURCE_NAME = "govua20";
    ...
    public void enrich(UUID portion) {
        ...
        try {
            ...
            while (!onePage.isEmpty()) {
                ...
                List<Govua20> finalWorkPortion = new ArrayList<>();
                List<Govua20> temp = new ArrayList<>();
                ...
                if (!temp.isEmpty()) {
                    govua20Repository.saveAll(temp);
                    extender.sendMessageToQueue(GOVUA20, newPortion);
