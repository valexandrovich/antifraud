...
public enum DataRegex {
    NAME_UK("^([А-ГҐДЕЄЖЗИІЇЙ-ЩЬЮЯа-гґдеєжзиіїй-щьюя']+-[А-ГҐДЕЄЖЗИІЇЙ-ЩЬЮЯа-гґдеєжзиіїй-щьюя']+)?([А-ГҐДЕЄЖЗИІЇЙ-ЩЬЮЯа-гґдеєжзиіїй-щьюя']+)?()$", "одне слово або два слова через дефіс українськими літерами"),
    NAME_RU("^([А-Яа-я]+-[А-Яа-я]+)?([А-Яа-я]+)?()$", "одне слово або два слова через дефіс російськими літерами"),
    NAME_EN("^([A-Za-z]+-[A-Za-z]+)?([A-Za-z]+)?()$", "одне слово або два слова через дефіс англійськими літерами"),
    ...
    CNUM("^([0-9]{1,6})?()$", "номер може містити до 6 цифр"),
