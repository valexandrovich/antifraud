        ...
        try {
            await fetch(`/api/schedule/exchangeSwitch/${group}`, {
                ...
                if (res.status === 200) {
                    fetchSchedule();
                    dispatch(
                        setAlertMessageThunk(`Группа активна ${search}`, "success")
                    );
                }
            });
        } catch (error) {
            ...
            <div className="row">
                <div className="form-group col-md-6 mb-2">
                    ...
                    >
                        ...
                        {uniqueArrayGroupName(data).sort().map((option) => {
                            return (
                        ...
                        .map((row, index) => {
                            return (
                                ...
                                >
                                    ...
                                    <TableItem item={row.schedule === null ? "-" : JSON.stringify(row.schedule)}/>
                                    <td>
                                        <input
