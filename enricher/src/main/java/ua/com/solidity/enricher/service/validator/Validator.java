...
import static ua.com.solidity.enricher.util.Regex.*;
...
public class Validator {
    ...
    public static boolean isValidInn(String inn, LocalDate birthDay) {
        inn = String.format(INN_FORMAT_REGEX, Long.parseLong(inn));
