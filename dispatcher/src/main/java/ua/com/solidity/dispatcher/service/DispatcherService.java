...
public class DispatcherService {
    ...
    public DispatcherResponse dispatch(List<EntityProcessing> people, String id) {
        log.info("Started processing id: {}, size: {}, current cache size: {}", id, people.size(), EntityStorage.peopleSet.size());
        ...
        EntityStorage.peopleSet.forEach(person -> {
        ...
        EntityStorage.peopleSet.addAll(resp);
        log.info("Processing stopped id: {}, processing: {}, skipping: {}, current cache size: {}", id, resp.size(), temp.size(), EntityStorage.peopleSet.size());
        return response;
    }

    public boolean remove(Set<EntityProcessing> resp) {
        log.info("Remove started size: {}", resp.size());
        boolean result = EntityStorage.peopleSet.removeAll(resp);
        log.info("Remove finished current cache size: {}", EntityStorage.peopleSet.size());
        return result;
    }
}
