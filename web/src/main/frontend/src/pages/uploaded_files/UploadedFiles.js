                            ...
                            <tr key={el.uuid}>
                                ...
                                <td>
                                    <div className="d-flex align-items-center">
                                        <button onClick={() => enrich(el.uuid)} className="btn custom-btn">Завантажити
                                        </button>
                                        <span onClick={() => setConfirmationRemove(el.uuid)}
                                              style={{color: "red", fontSize: "30px"}}><IoIcons.IoMdTrash
                                            className="mr-10"/></span>
                                    </div>
                                </td>
